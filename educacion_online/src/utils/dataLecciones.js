const lessons = [
    {
      id: 1,
      title: "Introducción al Álgebra 1",
      duration: "2 horas",
    ...
    {
      id: 2,
      title: "Introducción al Álgebra 2",
      duration: "2 horas",
      videoUrl: "https://www.youtube.com/watch?v=k5Eqw-8gSiY",
      content: {
        introduction:
          "¡Bienvenido a esta sesión introductoria sobre álgebra! En esta lección, exploraremos los conceptos básicos del álgebra y su importancia en las matemáticas y otras disciplinas.",
        definition: {
  ...
  
    {
      ...
      duration: "1.5 horas",
      videoUrl: "https://www.youtube.com/watch?v=nSAYRU2a0Ws&list=RDMM&start_radio=1&rv=k5Eqw-8gSiY", // Agrega la URL del video para la lección 2
    },
    {
      id: 4,
      ...
      duration: "2 horas",
      videoUrl: "https://www.youtube.com/watch?v=aJ5IzGBnWAc&list=RDMM&index=7", // Agrega la URL del video para la lección 1
    },
  ];
