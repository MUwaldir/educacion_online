    ...
    <nav className="bg-black p-4 fixed w-full z-50">
      <div className="container mx-auto flex justify-between items-center ">
        ...
        <div className="hidden lg:flex lg:items-center lg:justify-end">
          <Link to="/courses" className="text-white mr-4 hover:text-gray-400">
            Cursos
          </Link>
          <Link to="/about" className="text-white mr-4 hover:text-gray-400">
            Acerca de
          </Link>
          {/* <Link to="/contact" className="text-white mr-4 hover:text-gray-400">Contacto</Link> */}
          <Link to="/login" className="text-white mr-4 hover:text-gray-400">
            Iniciar Sesión
          </Link>
