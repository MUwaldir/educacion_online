...
//   };
  ...
  return (
    ...
    <div className="flex-grow  h-full flex flex-col justify-evenly p-4  text-black" style={{backgroundColor : '#fff6ed'}}>
      ...
      <div className="max-w-md mx-auto w-full md:w-1/2">
        ...
        <button
          className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition-colors"
          onClick={handleLogin}
        >
          Iniciar Sesión
        </button>
